    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md bg-gradient-to-b from-[#031C30] to-[#0a2540] border-none p-0">
        ...
        <div className="flex flex-col items-center justify-center p-6 text-white">
          ...
          <h2 className="text-2xl font-semibold mb-6">You have completed the quiz!</h2>
          <p className="text-gray-300 mb-6 text-center">Great job! Your responses have been submitted successfully.</p>
          <Button
