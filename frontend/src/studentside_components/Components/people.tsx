    ...
    <div className="flex flex-col w-full max-w-3xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
      ...
      <div className="p-8">
        ...
        <div className="w-full">
          <div className="grid grid-cols-[1fr,auto] py-3 border-b border-gray-300 text-sm font-semibold text-gray-700">
          ...
          <div
            className={`space-y-2 ${
              students.length > 4
                ? "max-h-[256px] overflow-y-auto your-scrollable-container"
                : ""
            }`}
          >
            {students.map((student, index) => (
              <div
                key={student.id}
                className={`grid grid-cols-[1fr,auto] items-center py-4 rounded-md ${
